...
// +kubebuilder:printcolumn:name="API",type=string,JSONPath=".spec.apiServer"
// +kubebuilder:printcolumn:name="Phase",type=string,JSONPath=".status.conditions[?(@.type=='Ready')].status"
